...
namespace CoffeeLands.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendBodyEmailAsync(SendMailRequest request)
        {
            string FilePath = Directory.GetCurrentDirectory() + $"\\wwwroot\\customer\\email\\{request.Url}.html";
            ...
            email.Subject = $"Notification To {request.UserName}";
            var builder = new BodyBuilder();
